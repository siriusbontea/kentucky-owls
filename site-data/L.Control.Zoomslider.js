  ...
  return L.Control.extend({
    ...
    _createZoomBtn: function (zoomDir, end, container) {
      var classDef =
          ...
          "-" +
          zoomDir +
          " leaflet-bar-part leaflet-bar-part-" +
          end,
    ...
    _onSliderClick: function (e) {
      ...
      this._knob.setPosition(y), this._updateMapZoom();
    },
    _zoomIn: function (e) {
    ...
    _zoomLevels: function () {
      ...
      return zoomLevels < 1 / 0 ? zoomLevels : 0;
    },
    ...
    _updateDisabled: function () {
      ...
      L.DomUtil.removeClass(this._ui.zoomIn, className),
        ...
        zoomLevel === this._map.getMinZoom() &&
          L.DomUtil.addClass(this._ui.zoomOut, className),
        zoomLevel === this._map.getMaxZoom() &&
          L.DomUtil.addClass(this._ui.zoomIn, className);
    },
  });
})()),
  L.Map.mergeOptions({ zoomControl: !1, zoomsliderControl: !0 }),
  L.Map.addInitHook(function () {
    this.options.zoomsliderControl &&
